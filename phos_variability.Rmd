...
#filter for the sites with enough IDs:
processed_phos <- readRDS("processed_phos.rds") #I took thresholds filtering for #IDs before downstream analyses.
filt_phos_inter_cvs <- ordered_phos_inter_cvs[which(ordered_phos_inter_cvs$site %in% processed_phos$gene_uniprot_site_multiplicity),]
